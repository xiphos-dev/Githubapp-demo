...
class GithubAnalyzeDiff():
    ...
    async def _aprep_clash(self,
        ...
        You are a helpful AI assistant, knowledgeable about the Github API. You will be reporting to the user about the information yielded by a previous pull request query. Specifically, you will receive a diff patch containing the modifications made to a file inside a given pull request. Your task is to give a concise report about the changes made. Your answer must be a numbered list of the main modifications, each with a description.<|eot_id|><|start_header_id|>user<|end_header_id|>
        This is the diff patch for the modified file:´´´\n{user_prompt}\n´´´<|eot_id|><|start_header_id|>assistant<|end_header_id|>
        '''
        ...
        output =    together.Complete.create(
                    ...
                    prompt=instruction.format(user_prompt = self.patch),
...
#class GithubListPullRequest(BaseTool):
    ...
    async def _aprep_clash(self,
        ...
        output =    together.Complete.create(
                    ...
                    #model="NousResearch/Nous-Hermes-2-Mixtral-8x7B-SFT",   
                    #model="Qwen/Qwen1.5-14B-Chat",
                    prompt=instruction.format(user_prompt = self.user_q),
                    #model="Qwen/Qwen2-72B-Instruct",
                    model="meta-llama/Llama-3-70b-chat-hf",
                    #model="meta-llama/Llama-3-8b-chat-hf",
                    #model="deepseek-ai/deepseek-coder-33b-instruct",
...
user_q = "I want to see the modifications made to 5"
...
analisis = GithubAnalyzeDiff(res["diff"][0]["patch"])
